<div id="{{ $id }}" class="hidden {{ $absolute ? 'absolute inset-0 z-[50]' : 'fixed inset-0 z-[110]' }} items-center justify-center bg-white/60 backdrop-blur-sm dark:bg-slate-900/60">
