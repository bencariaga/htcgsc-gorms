...
<header class="h-20 bg-white dark:bg-slate-800 border-b-2 border-slate-200 dark:border-slate-700 flex items-center justify-between pl-5 pr-10 z-10 shadow-sm transition-colors duration-300">
