...
- Name: reports.spec.js >> Report CRUD >> should delete a report
- Location: tests\Browser\reports.spec.js:21:5
...
Call log:
  - navigating to "http://localhost:8000/reports", waiting until "load"
