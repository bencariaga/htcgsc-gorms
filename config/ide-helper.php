...
use Illuminate\{Http\Client\Factory, Http\Client\PendingRequest, Session\Store};
...
return [
    ...
    */
    ...
    'helper_files' => collect(['Support', 'Foundation'])->map(fn ($package) => base_path("vendor/laravel/framework/src/Illuminate/{$package}/helpers.php"))->toArray(),
    ...
    */
    ...
    'ignored_models' => [/* App\MyModel::class, */],
    ...
    */
    ...
    'extra' => ['Eloquent' => [EloquentBuilder::class, QueryBuilder::class], 'Session' => [Store::class]],
    ...
    */
    ...
    'interfaces' => [/* App\MyInterface::class => App\MyImplementation::class, */],
    ...
    */
    ...
    'type_overrides' => ['integer' => 'int', 'boolean' => 'bool'],
    ...
    */
    ...
    'macro_default_return_types' => [Factory::class => PendingRequest::class],
